...
/**
 * MovieManager class.
 * This will manage Create , Read , Update and Delete movie realated objects and information.
 * This contrtols movie listings as well.
 */
public class MovieManager {
    ...
    /**
     * Checks whether MovieManager has been instantiated before.
     */
    ...
    /**
     * Prints out Main User Interface for MovieMenu. Here, we can view, edit add and search for movies.
     */
    ...
    /**
     * Method to search for movies. The input is NOT case sensitive. 
     * If no matches, the user will be informed.
     * 
    ...
    /**
     * Method to addMovies.  
     * Receives input from Staff.   Staff will then confirm details are correct as Staff is prompted to submit new movie, edit details of new movie or discard new move.
     */
    ...
    /**
     * Method prints Edit Movie Menu for Staff.  Attributes of the Movie can be modified/edited here.
    ...
    /**
     * Changes showtime to END_OF_SHOWING , which is the definition for removing a movie. (Clarified in FAQ)
    ...
    /**
     * Print menu to view the top 5 movies.
     * Can view the top 5 movies in terms of 
     * 1. Sales
     * 2. Tickets Sold
