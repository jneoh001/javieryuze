...
/**
 * This is the SystemSettingsManager. It will interface with the system settings
 * to perfomr CRUD operations.
 * It will also allow external managers to access its methods to modify ticket
 * prices
 *
 */
public class SystemSettingsManager {
	// Attributes
	/**
	 * Holds the systemsettings object, that has a hashmap of all the available
	 * system settings
	...
	/**
	 * Instantiates the SystemSettingsManager singleton. If no previous instance has
	 * been created,
	...
	// Constructor
	/**
	 * Constructor of the SystemSettingsManager. It will first try to load a
	 * serialized file of the class SystemSettings
	 * If it fails, it will create the system settings from the initialization files
	 * that we have preloaded and then serialize it for future use
	 */
	...
	/**
	 * Gets the value of a certain ticket attribute such as BASE (base price) /
	 * BOOKING (booking price modifier) / MON (Monday price modifier)
	 * 
	 * @param key This is the keyword present in system settings
	 * @return This returns a value by which the base ticket price should be
	 *         modified
	 */
	...
	/**
	 * Similar to getPrice(String key), except that this checks whether the specific
	 * date of the showtime is a holiday or not.
	 * 
	 * @param date This is the date of the showtime
	 * @return This returns the value of the holiday price modifier if the date is a
	 *         holiday, or returns 0 if it is not a holiday
	 */
	...
	/**
	 * This is an option menu, the entry point into the System Settings App where a
	 * staff can come to CRUD the system settings
	 */
	...
	/**
	 * This is an option menu where a staff can come in to view the various system
	 * settings available to them.
	 * There are many categories of settings, and the staff can get a good overview
	...
	private void viewSystemSetting() {
		...
		if (choice == 1)
			...
			System.out.println("Back to SystemSettings");
		} else {
			System.out.println("Invalid choice. Please choose between 0-8.");
		}
	...
	/**
	 * This is an option menu where a staff will come in to enter a new system
	 * setting.
	 * The only system setting that actually makes sense to add will be a holiday
	 * reference, since new holidays can be
	 * easily declared, but new movie formats or new cinema types are very rare, and
	 * it's not possible to create a new day of the week
	 */
	private void addSystemSetting() {
		...
		// this.systemSettings.addSetting("holidayReference", newHolidayDate,
		// newHolidayName);
		// this.systemSettings.viewSetting("holidayReference");
		// break;
		// case 0:
	...
	/**
	 * This is an option menu, where the staff will decide what kind of system
	 * settings they would like to change.
	 * It is sorted by categories and hence the staff can easily pick what kind of
	...
	private void changeSystemSetting() {
		...
		// System.out.println("Enter date of holiday you want to change in format
		// YYYY-MM-DD: ");
		...
		// this.systemSettings.updateSetting("holidayReference", newHolidayDate,
		// newHolidayName);
		// this.systemSettings.viewSetting("holidayReference");
		// break;
		// case 2:
		...
		// this.systemSettings.updateSetting("movieFormat$", newMovieFormatName,
		// newMovieFormatModifier);
		// this.systemSettings.viewSetting("movieFormat$");
		// break;
		// case 3:
		// this.systemSettings.viewSetting("ticketType$");
		...
		// this.systemSettings.updateSetting("ticketType$", newTicketTypeName,
		// newTicketTypeModifier);
		// this.systemSettings.viewSetting("ticketType$");
		// break;
		// case 4:
		// this.systemSettings.viewSetting("cinemaType$");
		...
		// this.systemSettings.updateSetting("cinemaType$", newCinemaTypeName,
		// newCinemaTypeModifier);
		// this.systemSettings.viewSetting("cinemaType$");
		// break;
		// case 5:
		// this.systemSettings.viewSetting("dayOfWeek$");
		...
		// this.systemSettings.updateSetting("dayOfWeek$", newDayOfWeekName,
		// newDayOfWeekModifier);
		// this.systemSettings.viewSetting("dayOfWeek$");
		// break;
		// case 6:
		// this.systemSettings.viewSetting("holiday$");
		...
		// this.systemSettings.updateSetting("default$", newDefaultName,
		// newDefaultModifier);
		// this.systemSettings.viewSetting("default$");
		// break;
		// case 0:
	...
	/**
	 * This is where a staff can come in to delete a system settings. Similar to
	 * adding a system setting, the only
	 * setting that makes sense to be added is a new holiday reference. Any new
	 * movie format or cinema will be a structural change
	 * to the entire cinema, and not something that needs to be accounted for in the
	 * MOBLIMA app
	 */
	private void deleteSystemSetting() {
		...
		Systemout.println("=================== Delete SystemSettings ==================\n" +
		" 1. Holiday Reference                                     \n" +
		" 0. Back to SystemSettings Menu                           \n" +
		"============================================================");
			System.out.println("Enter choice:");
	...
	/**
	 * This is used to load all of the system settings from the "database". If it
	 * fails to load, it will return null.
	 * The constructor will then create the system settings data file. This will
	 * only occur upon initialisation (the very first run of the app)
	 * Or when data is cleared
	 * 
	 * @return This returns all the SystemSettings available as the SystemSettings
	 *         class
	 */
